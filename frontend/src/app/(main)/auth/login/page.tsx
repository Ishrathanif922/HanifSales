...
export default function LoginPage() {
  ...
  const { dispatch, refreshUser, refreshCart } = useApp();
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-indigo-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center p-12 w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium">Welcome to Hanif Sales</span>
            </div>
            <h1 className="text-4xl font-bold mb-4">Discover Premium Products</h1>
            <p className="text-lg text-white/80 max-w-md">
              Shop from thousands of sellers across Pakistan. Authentic products, secure payments, and fast delivery.
            </p>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <Input id="password" type={showPassword ? "text" : "password"} {...register("password")} placeholder="Enter your password" className="pl-11 pr-11 h-12 rounded-xl" />
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-gray-50 dark:bg-dark-bg px-3 text-gray-500 font-medium">or continue with</span></div>
          </div>

          <Button type="button" onClick={handleGoogleLogin} variant="outline" className="w-full h-12 rounded-xl gap-2 font-medium">
